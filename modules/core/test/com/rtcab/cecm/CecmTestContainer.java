...
public class CecmTestContainer extends TestContainer {

    public CecmTestContainer() {
        super();
    ...
    public static class Common extends CecmTestContainer {

        public static final CecmTestContainer.Common INSTANCE = new CecmTestContainer.Common();
